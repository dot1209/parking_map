...
webdriver_path = os.path.join(base_path, "webdriver", "chromedriver.exe")
...
def crawl_building():
    with open(os.path.join(data_path, "building_distance.json"), "r", encoding="utf-8") as f:
    ...
    with tqdm(total=110*22) as pbar:
